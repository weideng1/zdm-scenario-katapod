...
sed -i '/\$HOME\/.bashrc.d\//a pip install -r \/workspace\/zdm-scenario-katapod\/client_application\/requirements.txt 2>\&1 >> \/workspace\/zdm-scenario-katapod\/katapod_logs\/pip-install-upon-ssh.log' /home/ubuntu/.bashrc ;
